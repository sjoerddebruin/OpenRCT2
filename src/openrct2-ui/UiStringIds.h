...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_CHALLENGE_FORBID_HIGH_CONSTRUCTION = 7045,
        STR_CHALLENGE_FORBID_LANDSCAPE_CHANGES = 7043,
        STR_CHALLENGE_FORBID_MARKETING_CAMPAIGNS = 7046,
        STR_CHALLENGE_FORBID_TREE_REMOVAL = 7044,
        STR_CHALLENGE_HARD_GUEST_GENERATION = 7047,
        STR_CHALLENGE_HARD_PARK_RATING = 7048,
        STR_CHALLENGE_INTENSITY_PREFERENCE_LESS = 7050,
        STR_CHALLENGE_INTENSITY_PREFERENCE_MORE = 7051,
        STR_CHALLENGE_PARK_MUST_STAY_OPEN = 7049,
        STR_CHALLENGE_PRESERVED_RIDES = 7052,
        STR_CLOSE_PARK = 1013,
        STR_CLOSE_PARK_TIP = 5296,
        STR_ENTER_NAME = 2791,
        STR_ENTER_NAME_INTO_SCENARIO_CHART = 2790,
        STR_EXTRA_CHALLENGES_LABEL = 7041,
        STR_EXTRA_CHALLENGE_MARKER = 7042,
